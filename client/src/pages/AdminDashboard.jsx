...
export default function AdminDashboard() {
  ...
  const handleProfileUpdate = async (e) => {
    ...
    try {
      ...
      if(profile && profile.desk) {
          profile.name = profileData.name;
          profile.desk.name = profileData.desk_name;
      }
    } catch(err) {
                    ...
                    <div className="p-0 overflow-x-auto">
                      {loading ? (
                         <div className="p-16 flex flex-col items-center justify-center text-slate-500 h-64 bg-slate-50/50 dark:bg-slate-900/30">
                            ...
                            <p className="font-semibold text-lg animate-pulse tracking-wide">Syncing administrative queue...</p>
                         </div>
                          ...
                          <div className="space-y-5">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                              <div>
                                ...
                                <input type="text" value={profileData.desk_name} onChange={e => setProfileData({...profileData, desk_name: e.target.value})} className="input-field py-2.5 font-semibold text-slate-800 dark:text-white" required />
                              </div>
                              <div className="opacity-60 cursor-not-allowed">
                                ...
                                <input type="text" value={`Desk ${profile?.desk?.order_index || 'N/A'}`} disabled className="input-field py-2.5 font-semibold text-slate-500 dark:text-slate-500 cursor-not-allowed bg-slate-100 dark:bg-slate-800/50 border-0" />
                                <p className="text-[10px] text-slate-500 mt-1.5 font-semibold">Contact System Admin to alter pipeline routing.</p>
                              </div>
                            </div>
                          ...
                          <div className="grid grid-cols-2 gap-8 pt-4">
                             ...
                             <div>
                               <p className="text-xs text-slate-400 font-bold uppercase tracking-widest flex items-center justify-between">
                                  ...
                                  <span className="inline-flex px-3 py-1 rounded-full text-[10px] font-black bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-800 break-keep">Read-Only</span>
                               </p>
